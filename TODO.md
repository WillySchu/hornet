...
- Multi-way / exhaustive matching — something like shape is Circle or shape is Square, or eventually a dedicated match/switch-style construct that can check exhaustiveness against all of a sum type's variants at compile time. Distinct from item 1; this is about checking multiple variants at once, not just composing boolean logic.
