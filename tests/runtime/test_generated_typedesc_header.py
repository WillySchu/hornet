...
codegen/strings.py's own live _TYPEDESC_* constants.
...
_TYPEDESC_* value in codegen/strings.py and forgets to re-run the
...
def test_generated_header_matches_checked_in_file():
    ...
    assert checked_in == freshly_generated, (
        ...
        "codegen/strings.py's own _TYPEDESC_* constants -- re-run "
