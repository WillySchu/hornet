...
EXPECTED_EXIT_CODES = {
    ...
    'calling_convention_heavy': 107,  # array-typed, slice-typed, and array-typed-struct-field function arguments (the last exercising the Field-argument fix), in a hot loop
}
